...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        // Escrow purchase route
        Route::post('/ad/{id}/buy', 'AdController@buyWithEscrow')->name('ad.buy.escrow');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            //promote ad
            Route::get('profile-setting', 'UserControllerromote.ad.packages');
...
Route::post('/escrow/{id}/release', 'EscrowController@release')->name('escrow.release');
